...
const me={
    ...
    calcage: function(){
        ...
        return this.age;//here this will  access the birthyear given  in the object so we wont have to pass some input to this method any time now we call it, can use me.birthyear too
    }
}
//two ways to call this method 
console.log(me.calcage());
